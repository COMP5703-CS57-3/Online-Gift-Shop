...
class TestAdmin(unittest.TestCase):
    ...
    #         sleep(100)
    #         curr_url = driver.current_url
    #         self.assertEqual(curr_url, "http://localhost:3000/")
    ...
    #     if self.driver.current_url == "http://localhost:3000/administer/gui":
    #         driver.find_element_by_xpath(
    #             '//*[@id="giftSelect-2-Show"]').click()
    #         sleep(10)
    #         driver.find_element_by_xpath('//*[@id="root"]/div/main/main/div/div[1]/div[1]/div[2]/button[3]').click()
    #         driver.find_element_by_xpath('//*[@id="giftPrice-Edit"]').send_keys("123")
    #         driver.find_element_by_xpath('//*[@id="giftDiscountState-Edit"]').send_keys("80")
    #         driver.find_element_by_xpath('//*[@id="giftCategory-Edit"]').send_keys("Birthday")
    #         driver.find_element_by_xpath('//*[@id="giftCategory-Edit"]').send_keys(Keys.ENTER)
    #         driver.find_element_by_xpath('//*[@id="giftSideCategory1-Edit"]').send_keys("Male")
    #         driver.find_element_by_xpath('//*[@id="giftSideCategory1-Edit"]').send_keys(Keys.ENTER)
    #         driver.find_element_by_xpath('//*[@id="giftSideCategory2-Edit"]').send_keys("Young")
    #         driver.find_element_by_xpath('//*[@id="giftSideCategory2-Edit"]').send_keys(Keys.ENTER)
    #         driver.find_element_by_xpath('//*[@id="submit-Edit"]').click()
    #         sleep(100)
    #         curr_url = driver.current_url
    #         self.assertEqual(curr_url, "http://localhost:3000/")

    def editGiftBad(self):
        driver = self.driver
        driver.find_element_by_xpath(
            '//*[@id="root"]/div/div/div/nav/div[3]').click()
        sleep(150)
